...
function iconUrl(deck,idx){
  ...
  if(typeof idx==='string'){
    return `/img/decks/${info.folder}/characters/${idx}`;
  }
  return `/img/decks/${info.folder}/characters/char${(idx||0)+1}.png`;
}
